export const projects = [
    {
        ...
        image: "/images/portfolioWebsiteRepoImg.png",
    ...
    },
    {
        ...
        image: "/images/ReactPlaygroundImg.png",
    ...
    },
    {
        ...
        description: "Professional website pages designed and developed for my current role, utilizing HTML, CSS, JavaScript, and Bootstrap 5. Responsibilities included implementing responsive layouts, optimizing for accessibility, and ensuring cross-browser performance. These projects highlight my ability to deliver production-ready code in a real-world environment. REWORK THIS TEXT AS IT CAN BE BETTER!",
        image: "/images/VPSitesImgCollage.png",
    ...
    },
    {
        ...
        description: "A full redesign project beginning with wireframes in Adobe XD and was then coded into a functional, responsive demo site. This project demonstrates my ability to merge creative UX/UI design with solid front-end development, translating visuals into user-friendly, accessible code.",
        image: "/images/ToughMudderRedesignImg.png",
